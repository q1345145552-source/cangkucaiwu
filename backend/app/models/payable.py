...
class PayableBill(Base):
    ...
    source = Column(String(20), nullable=True, default="manual", comment="账单来源: purchase_order / manual")
    purchase_order_id = Column(Integer, ForeignKey("purchase_orders.id"), nullable=True, comment="关联采购单ID")
    need_boss_confirm = Column(String(5), nullable=True, default="false", comment="收货差异待老板确认: true/false")
