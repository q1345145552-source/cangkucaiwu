...
const navItems: NavItem[] = [
  { key: "dashboard", label: "dashboard", icon: <LayoutDashboard size={20} />, href: "/dashboard", roles: ["super_admin", "warehouse_admin", "staff"] },
  {
    ...
    children: [
      { key: "customers", label: "customers", icon: <Users size={18} />, href: "/customers", roles: ["super_admin", "warehouse_admin", "staff"] },
      { key: "warehouses", label: "warehouses", icon: <Warehouse size={18} />, href: "#", roles: ["super_admin"] },
      { key: "accounts", label: "accounts", icon: <CreditCard size={18} />, href: "/accounts", roles: ["super_admin", "warehouse_admin"] },
      { key: "suppliers", label: "suppliers", icon: <Truck size={18} />, href: "/suppliers", roles: ["super_admin", "warehouse_admin"] },
      
    ],
  },
  { key: "recharge", label: "recharge", href: "/recharge", icon: <ArrowDownUp size={20} />, roles: ["super_admin", "warehouse_admin", "staff"] },
  { key: "incoming", label: "incoming", href: "/incoming", icon: <TrendingUp size={20} />, roles: ["super_admin"] },
  { key: "reconciliation", label: "reconciliation", href: "/reconciliation", icon: <CheckCircle size={20} />, roles: ["super_admin", "warehouse_admin"] },
  { key: "income_expense", label: "income_expense", href: "/income-expense", icon: <CreditCard size={20} />, roles: ["super_admin", "warehouse_admin"] },
  { key: "expense_fund", label: "expense_fund", href: "/expense-fund", icon: <PiggyBank size={20} />, roles: ["super_admin", "warehouse_admin", "staff"] },
  { key: "reimbursement", label: "reimbursement", href: "/reimbursement", icon: <Receipt size={20} />, roles: ["super_admin", "warehouse_admin", "staff"] },
  { key: "payable", label: "payable", href: "/payable", icon: <FileText size={20} />, roles: ["super_admin", "warehouse_admin"] },
  { key: "credit", label: "credit", href: "/credit", icon: <Clock size={20} />, roles: ["super_admin", "warehouse_admin"] },
  ...
  { key: "reports", label: "reports", href: "/reports", icon: <BarChart3 size={20} />, roles: ["super_admin", "warehouse_admin", "staff"] },
