...
const navItems: NavItem[] = [
  { key: "dashboard", label: "dashboard", icon: <LayoutDashboard size={20} />, href: "/dashboard", roles: ["warehouse_admin", "staff", "supervisor"] },
  {
    key: "finance_ops_group", label: "finance_ops_group_label", icon: <CreditCard size={20} />,
    roles: ["warehouse_admin", "staff", "supervisor"],
    children: [
      { key: "customers", label: "customers", icon: <Users size={18} />, href: "/customers", roles: ["warehouse_admin", "staff", "supervisor"] },
      { key: "warehouses", label: "warehouses", icon: <Warehouse size={18} />, href: "/warehouses", roles: ["warehouse_admin", "super_admin"] },
      { key: "accounts", label: "accounts", icon: <CreditCard size={18} />, href: "/accounts", roles: ["warehouse_admin", "super_admin", "supervisor"] },
      { key: "recharge", label: "recharge", icon: <ArrowDownUp size={18} />, href: "/recharge", roles: ["warehouse_admin", "staff", "supervisor"] },
      { key: "incoming", label: "incoming", icon: <TrendingUp size={18} />, href: "/incoming", roles: ["warehouse_admin", "super_admin", "supervisor"] },
      { key: "reconciliation", label: "reconciliation", icon: <CheckCircle size={18} />, href: "/reconciliation", roles: ["warehouse_admin", "super_admin", "supervisor"] },
    ],
  },
  {
    ...
    children: [
      ...
      { key: "other_income_expense", label: "other_income_expense", icon: <FileText size={18} />, href: "/other-income-expense", roles: ["warehouse_admin", "super_admin", "supervisor"] },
      ...
      { key: "credit", label: "credit", icon: <Clock size={18} />, href: "/credit", roles: ["warehouse_admin", "super_admin", "supervisor"] },
      { key: "reports", label: "reports", icon: <BarChart3 size={18} />, href: "/reports", roles: ["warehouse_admin", "staff", "supervisor"] },
      { key: "ledger", label: "ledger", icon: <FileText size={18} />, href: "/ledger", roles: ["warehouse_admin", "super_admin", "supervisor"] },
    ],
  },
  {
  ...
  { key: "modification_logs", label: "修改日志", icon: <History size={20} />, href: "/modification-logs", roles: ["super_admin", "warehouse_admin"] },
  {
    ...
    children: [
      { key: "market", label: "market", icon: <ShoppingBag size={18} />, href: "/market", roles: ["super_admin", "warehouse_admin", "staff", "supervisor"] },
      { key: "group_order", label: "group_order", icon: <PackageOpen size={18} />, href: "/group-order", roles: ["super_admin", "warehouse_admin", "supervisor"] },
    ],
  },
  {
    key: "hr_group", label: "employee_group", icon: <ClipboardList size={20} />,
    roles: ["warehouse_admin", "super_admin", "supervisor"],
    children: [
      { key: "employees", label: "员工档案", icon: <Users size={18} />, href: "/employees", roles: ["warehouse_admin", "super_admin", "supervisor"] },
      ...
      { key: "payroll", label: "payroll", icon: <DollarSign size={18} />, href: "/payroll", roles: ["warehouse_admin", "super_admin", "supervisor"] },
      { key: "labor_efficiency", label: "人效管理", icon: <Gauge size={18} />, href: "/labor-efficiency", roles: ["warehouse_admin", "super_admin", "supervisor"] },
    ],
  },
  {
    ...
    children: [
      { key: "settings", label: "settings", icon: <Settings size={18} />, href: "/settings", roles: ["super_admin", "warehouse_admin", "staff", "supervisor"] },
